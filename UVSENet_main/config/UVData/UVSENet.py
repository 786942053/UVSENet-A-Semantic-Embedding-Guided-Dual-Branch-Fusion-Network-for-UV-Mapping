...
train_dataset = UVDataset(data_root='/root/autodl-tmp/data/UVData/train', mode='train', mosaic_ratio=0.25, transform=train_aug, embed_root='/root/autodl-tmp/embed/UVData/train' )
val_dataset = UVDataset(data_root='/root/autodl-tmp/data/UVData/val', mode='val',transform=val_aug, embed_root='/root/autodl-tmp/embed/UVData/val')
test_dataset = UVDataset(data_root='/root/autodl-tmp/data/UVData/test', mode='test',transform=val_aug, embed_root='/root/autodl-tmp/embed/UVData/test')
