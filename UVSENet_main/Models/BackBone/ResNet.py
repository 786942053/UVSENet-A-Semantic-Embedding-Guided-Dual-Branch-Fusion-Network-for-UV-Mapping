...
from .WTConv import WTConv2d_MS
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1 = SeparableConvBNAct(in_channels, self.inplanes, kernel_size=7, stride=2, dilation=1, norm_layer=norm_layer, act_layer=nn.ReLU)
        ...
        self.wtconv1 = WTConv2d_MS(64, 64,kernel_sizes=[1, 3, 5])
        self.wtconv2 = WTConv2d_MS(256, 256,kernel_sizes=[1, 3, 5])
        self.wtconv3 = WTConv2d_MS(512, 512,kernel_sizes=[1, 3, 5])
        self.wtconv4 = WTConv2d_MS(1024, 1024,kernel_sizes=[1, 3, 5])     
        self.wtconv5 = WTConv2d_MS(2048, 2048,kernel_sizes=[1, 3, 5]) 
